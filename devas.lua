-- Painel evilDrock - PC + ANDROID
-- Adaptado para funcionar bem em telas pequenas e com touch
...
do
    ...
    makePreset("TP LOREN",      8,   184, Color3.fromRGB(100, 50, 180), Vector3.new(2157.08, -242.87, 805.57))
    makePreset("TP BAU",        178, 184, Color3.fromRGB(180, 120, 60), Vector3.new(2111.97, -230.92, 258.67))
